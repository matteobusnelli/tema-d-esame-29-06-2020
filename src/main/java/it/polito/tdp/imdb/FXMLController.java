...
import it.polito.tdp.imdb.model.DirectorAtt;
...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(anno!=null) {
    		...
    		boxRegista.getItems().addAll(this.model.getDirector());
    	}else {
    ...
    void doRegistiAdiacenti(ActionEvent event) {
    	...
    	if(dir != null) {
    		txtResult.appendText("Attori vicini a "+dir.getFirstName()+" "+dir.getLastName()+"\n");
    		for(DirectorAtt d : this.model.getDirectorAtt(dir)) {
